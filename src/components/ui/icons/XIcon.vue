<template>
  <svg xmlns="http://www.w3.org/2000/svg" id="Bold" viewBox="0 0 24 24" width="28" height="28"
    @mouseenter="hover = true" @mouseleave="hover = false" class="hover:cursor-pointer"
  >
    <path :fill="hover ? 'red' : 'white'"
