<template>
  <div class="flex flex-col gap-1">
    <div class="flex flex-row items-center gap-4 pb-0.5 border-b border-dotted border-secondary-400">
    ...
    <div v-if="!update" class="flex flex-row items-center gap-4 pb-0.5 border-b border-dotted border-secondary-400">
