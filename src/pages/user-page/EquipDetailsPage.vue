<template>
  <overlay-z>
    <card-entity :header="header" class="w-full lg:w-10/12 xl:w-8/12 2xl:w-7/12 h-1/2">
      <template #body>
        <div class="p-4 flex flex-col">
          <div class="flex flex-row gap-4 py-2 border-b-2 border-slate-500">
            <div class="flex flex-row gap-2 w-1/2">
              <span>Наименование</span>
              <strong class="border-b-2 border-slate-400 px-2">{{ entity.shortName }}</strong>
            </div>
            <div class="flex flex-row gap-2 w-1/2">
          ...
          <div>
            <div class="py-2 border-b"><button-z-v1 title="add" class="bg-slate-500" /></div>
