<template>
  <div class="relative flex h-full justify-center items-start">
    <card-z-v2 class="w-full h-full" :cardData="cardData" header="Departments" navigation searchable editFloat footer>
      <template #body>
...
const { cardData, entities } = storeToRefs(useDepStore());
const { fetchEntities } = useDepStore();
